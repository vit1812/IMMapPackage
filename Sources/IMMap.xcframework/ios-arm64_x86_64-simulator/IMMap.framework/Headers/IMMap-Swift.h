...
SWIFT_CLASS("_TtC5IMMap17AFSessionDelegate")
...
@interface AFSessionDelegate (SWIFT_EXTENSION(IMMap)) <NSURLSessionDownloadDelegate>
...
@interface AFSessionDelegate (SWIFT_EXTENSION(IMMap)) <NSURLSessionDelegate>
...
@interface AFSessionDelegate (SWIFT_EXTENSION(IMMap)) <NSURLSessionStreamDelegate>
...
@interface AFSessionDelegate (SWIFT_EXTENSION(IMMap)) <NSURLSessionDataDelegate>
...
@interface AFSessionDelegate (SWIFT_EXTENSION(IMMap)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC5IMMap17AnimatedImageView")
...
SWIFT_CLASS("_TtC5IMMap26EKAccessoryNoteMessageView")
...
SWIFT_CLASS("_TtC5IMMap19EKSimpleMessageView")
...
SWIFT_CLASS("_TtC5IMMap18EKAlertMessageView")
...
SWIFT_CLASS("_TtC5IMMap15EKButtonBarView")
...
SWIFT_CLASS("_TtC5IMMap17EKFormMessageView")
...
SWIFT_CLASS("_TtC5IMMap22EKImageNoteMessageView")
...
SWIFT_CLASS("_TtC5IMMap20EKMessageContentView")
...
SWIFT_CLASS("_TtC5IMMap17EKNoteMessageView")
...
SWIFT_CLASS("_TtC5IMMap25EKNotificationMessageView")
...
SWIFT_CLASS("_TtC5IMMap18EKPopUpMessageView")
...
SWIFT_CLASS("_TtC5IMMap27EKProcessingNoteMessageView")
...
SWIFT_CLASS("_TtC5IMMap19EKRatingMessageView")
...
SWIFT_CLASS("_TtC5IMMap18EKRatingSymbolView")
...
SWIFT_CLASS("_TtC5IMMap28EKRatingSymbolsContainerView")
...
SWIFT_CLASS("_TtC5IMMap11EKTextField")
...
SWIFT_CLASS("_TtC5IMMap23EKXStatusBarMessageView")
...
SWIFT_CLASS("_TtC5IMMap16IMDataManagement")
@interface IMDataManagement : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) IMDataManagement * _Nonnull shared;)
+ (IMDataManagement * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
...
+ (IMMapViewController * _Nullable)mapViewControllerWithMallId:(int32_t)mallId SWIFT_WARN_UNUSED_RESULT;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC5IMMap12TaskDelegate")
